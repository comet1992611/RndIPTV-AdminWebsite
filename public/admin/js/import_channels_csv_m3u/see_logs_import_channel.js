            ...
            '<div class="container">'+
                '<div class="row">'+
                    '<div class="btn-group inline pull-right">'+
                        '<div class="btn btn-small"><a class="btn btn-default btn-md" ng-click="see_logs_channels()"><i class="fa fa-check fa-md"></i>&nbsp;Submit</a></div>'+
...
export default importchannelLogs;